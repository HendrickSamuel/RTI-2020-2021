...
public class DonneeAnswerQuestion  implements DonneeRequete, Serializable
{
    private static final long serialVersionUID = -7418152313818902027L;
    /********************************/
    /*           Variables          */
    /********************************/
    private String _tag;
    ...
    /*         Constructeurs        */
    /********************************/
    public DonneeAnswerQuestion()
    {

    }

    public DonneeAnswerQuestion(String _tag, String _user, String _message)
    {
        this._tag = _tag;
        this._user = _user;
